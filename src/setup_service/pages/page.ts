...
export class Page<E extends DataModel> {
	...
	public constructor(page: MessageEmbed) {
		this._Page = page;
	}
...
export class DynamicPage<E extends DataModel> extends Page<E> {
	protected readonly _PageBuilder:
		| ((fields: Partial<E>) => MessageEmbed)
		| ((fields: Partial<E>) => Promise<MessageEmbed>);
	protected readonly _Validator:
		| ((fields: Partial<E>, res: string) => string)
		| ((fields: Partial<E>, res: string) => Promise<string>);
