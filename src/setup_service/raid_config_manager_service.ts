...
export class RaidConfigManagerService extends SetupService<IRaidConfig> {
    ...
    protected getEndPage(finished?: boolean): MessageEmbed {
        ...
        this._ClientTools.addFieldToEmbed(embed, 'Confirmations Channel', confirmationsChannel, {default: 'Unset', inline: true});
        this._ClientTools.addFieldToEmbed(embed, 'Allow Early Booster Location?', allowBooster ? 'Yes' : 'No', {inline: true});
        return embed;
    }
