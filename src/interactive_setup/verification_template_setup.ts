...
@(fluentProvide(VerificationTemplateSetup).inSingletonScope().done())
export class VerificationTemplateSetup extends InteractiveSetup<IVerificationTemplate> {
	...
	public constructor(
		...
		@inject(VerificationTemplateService) verificationTemplateService: VerificationTemplateService,
		...
		super(clientTools, command, template, updatable);
